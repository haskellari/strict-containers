...
-----------------------------------------------------------------------------
-- |
-- Module      :  Data.Strict.Map.Autogen.Strict.Internal
...
-- If you need value-lazy maps, use "Data.Strict.Map.Autogen.Lazy" instead.
...
--
-- >  import qualified Data.Strict.Map.Autogen.Strict as Map
--
...
-- are the same as for the "Data.Strict.Map.Autogen.Lazy" module, so if they are used
-- on strict maps, the resulting maps will be lazy.
-----------------------------------------------------------------------------

-- See the notes at the beginning of Data.Strict.Map.Autogen.Internal.
...
#if defined(__GLASGOW_HASKELL__)
import Data.Strict.Map.Autogen.Internal.DeprecatedShowTree (showTree, showTreeWith)
#endif
import Data.Strict.Map.Autogen.Internal.Debug (valid)

import Control.Applicative (Const (..), liftA3)
import Data.Semigroup (Arg (..))
import qualified Data.Set.Internal as Set
import qualified Data.Strict.Map.Autogen.Internal as L
...
-- prefer 'Data.Strict.Map.Autogen.Merge.Strict.merge' or
-- 'Data.Strict.Map.Autogen.Merge.Strict.mergeA'.
--
