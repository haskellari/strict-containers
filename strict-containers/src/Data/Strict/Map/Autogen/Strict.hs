...
-- necessary. When laziness /is/ required, use the functions in "Data.Strict.Map.Autogen.Lazy".
--
...
-- 'Data.Data.Data' instances are the same as for the "Data.Strict.Map.Autogen.Lazy" module, so
...
module Data.Strict.Map.Autogen.Strict
    ...
    -- | See "Data.Strict.Map.Autogen.Merge.Strict"
...
import Data.Strict.Map.Autogen.Strict.Internal
import Prelude ()
