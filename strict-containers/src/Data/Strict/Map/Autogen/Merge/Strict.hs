...
-----------------------------------------------------------------------------
-- |
-- Module      :  Data.Strict.Map.Autogen.Merge.Strict
...
-- determines strictness. If you use 'Data.Strict.Map.Autogen.Merge.Strict.mapMissing'
-- from this module then the results will be forced before they are
-- inserted. If you use 'Data.Strict.Map.Autogen.Merge.Lazy.mapMissing' from
-- "Data.Strict.Map.Autogen.Merge.Lazy" then they will not.
--
