...
-----------------------------------------------------------------------------
-- |
-- Module      :  Data.Strict.IntMap.Autogen.Strict.Internal
...
-- "Data.Strict.IntMap.Autogen.Lazy".
--
...
-- > import qualified Data.Strict.IntMap.Autogen.Strict as IntMap
--
...
-- an 'Int' (32 or 64).
--
-- Benchmarks comparing "Data.Strict.IntMap.Autogen.Strict" with other dictionary
...
-- the same as for the "Data.Strict.IntMap.Autogen.Lazy" module, so if they are used the
...
-- See the notes at the beginning of Data.Strict.IntMap.Autogen.Internal.
...
#ifdef __GLASGOW_HASKELL__
import Data.Strict.IntMap.Autogen.Internal.DeprecatedDebug (showTree, showTreeWith)
#endif
