...
uninitialised :: a
uninitialised = error "Data.Strict.Vector.Autogen.Mutable: uninitialised element. If you are trying to compact a vector, use the 'Data.Strict.Vector.Autogen.force' function to remove uninitialised elements from the underlying array."
