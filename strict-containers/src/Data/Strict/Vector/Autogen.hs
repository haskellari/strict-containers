...
instance Exts.IsList (Vector a) where
  ...
  fromList = Data.Strict.Vector.Autogen.fromList
  fromListN = Data.Strict.Vector.Autogen.fromListN
  toList = toList

instance Data a => Data (Vector a) where
  gfoldl       = G.gfoldl
  toConstr _   = G.mkVecConstr "Data.Strict.Vector.Autogen.Vector"
  gunfold      = G.gunfold
  dataTypeOf _ = G.mkVecType "Data.Strict.Vector.Autogen.Vector"
...
instance Traversable.Traversable Vector where
  ...
  traverse f xs =
      ...
      in  Data.Strict.Vector.Autogen.fromListN n Applicative.<$> Traversable.traverse f (toList xs)
